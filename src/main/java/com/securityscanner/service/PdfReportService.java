...
public class PdfReportService {
    ...
    private void buildPage(PDDocument document, WebsiteScan scan) throws IOException {
        ...
        try (PDPageContentStream content = new PDPageContentStream(document, page)) {
            ...
            // Open Ports
            content.setFont(new PDType1Font(Standard14Fonts.FontName.HELVETICA_BOLD), 11);
            content.showText("Open Ports");
            content.newLine();

            content.setFont(new PDType1Font(Standard14Fonts.FontName.HELVETICA), 11);
            content.showText("  " + (
                    scan.getOpenPorts() != null
                            ? clean(scan.getOpenPorts())
                            : "No risky open ports found"
            ));
            content.newLine();
            content.newLine();
            ...
            // Leaked Secrets
            content.setFont(new PDType1Font(Standard14Fonts.FontName.HELVETICA_BOLD), 11);
            content.showText("Leaked Secrets");
            content.newLine();

            content.setFont(new PDType1Font(Standard14Fonts.FontName.HELVETICA), 11);
            content.showText("  " + (
                    scan.getLeakedSecrets() != null
